...
//        }
        ...
        for (int i = 0; i < student.length; i++) {
            data[i][0] = exam6_input.readdata(student[i][1],"국어");
            data[i][1] = exam6_input.readdata(student[i][1],"영어");
            data[i][2] = exam6_input.readdata(student[i][1],"수학");
        }

        exam6_compute exam6_compute = new exam6_compute();

        exam6_output exam6_output = new exam6_output();
